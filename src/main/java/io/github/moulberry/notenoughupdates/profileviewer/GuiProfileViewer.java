...
public class GuiProfileViewer extends GuiScreen {
    ...
    //TODO fix below/write back into java/remove below
    /*const levels = [
            100,
            110,
            120,
            ...
            console.log()
    getPetLevel(levels, 200, 20, 43858101)

    function getPetLevel (levels, maxPetLevel, offset, exp) {
        let xpTotal = 0;
        let level = 1;
        ...
        for(let i=offset; i<offset+maxPetLevel-1; i++) {

            let levelIndex = i;
            let passed100 = false;
            if(levelIndex >= 99+offset){
                passed100 = true;
                levelIndex = 99+offset-1;
            }
            if(addLevel) {
                if(passed100) {
                    currentLevelRequirement = levels[levelIndex];
                    console.log(`I-100: ${(i-100)}`)
                    console.log(`levelIndex: ${levelIndex}`)
                    console.log(`currentLevelRequirment: ${currentLevelRequirement}`)
                } else {
                    currentLevelRequirement = levels[levelIndex]
                }
                ...
                let chosenlevel = passed100?99:levelIndex
                xpTotal += levels[chosenlevel]
            }
        }
        ...
        console.log(`currentLevelRequirement: ${currentLevelRequirement}`)
        console.log(`maxXP: ${xpTotal}`)
        console.log(`levelPercentage: ${currentLevelProgress/currentLevelRequirement}`)
        console.log(`levelXp: ${currentLevelProgress}`)
        console.log(`totalXp: ${exp}`)

    }*/


    public static PetLevel getPetLevel(JsonArray levels, int maxPetLevel, int offset, float exp) {
        float xpTotal = 0;
        float level = 1;
